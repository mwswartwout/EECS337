...
#define	CLR_FLAGS_SYMBOL(a)	(a &= ~FLAGS_SYMBOL)
	int		memory;
/*
 *	define the scanner attribute table (dynamic)
 */
...
extern	ATTRIBUTE *new_attribute( int token, char *buffer, unsigned int length, int format);
extern	void	free_attribute( ATTRIBUTE *attribute);
extern	void	free_attribute_list( ATTRIBUTE *attribute);
extern	void	free_attribute_table( void);
extern	void	print_attribute( ATTRIBUTE *attribute);
extern	void	print_attribute_table( void);
extern	ATTRIBUTE *attribute( int token, char *buffer, unsigned int length, int format);
#endif
